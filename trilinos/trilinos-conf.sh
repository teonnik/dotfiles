...
#  -DCMAKE_C_COMPILER=/usr/local/software/jureca/Stages/2016a/software/GCCcore/5.3.0/bin/gcc \
#  -DCMAKE_CXX_COMPILER=/usr/local/software/jureca/Stages/2016a/software/GCCcore/5.3.0/bin/gcc \
