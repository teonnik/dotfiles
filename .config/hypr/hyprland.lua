...
hl.bind(mainMod .. " + N",         hl.dsp.exec_cmd("hyprctl hyprsunset temperature 4000 && pkill -RTMIN+1 waybar"))
hl.bind(mainMod .. " + SHIFT + N", hl.dsp.exec_cmd("hyprctl hyprsunset identity && pkill -RTMIN+1 waybar"))
