...
'-Wextra', # extra warnings for C++ related projects
'-Werror', # all warnings reported as errors
'-Wc++98-compat', 
'-Wno-long-long',
'-Wno-variadic-macros',
...
# For a C project 'c99'(c11) instead of 'c++11'.
'-std=c++11',
...
# **DO NOT DELETE! The python file is compiled, 'flags' is used below!**
